 ...
 * Usage: node apply-labels.js <owner/repo> [--owner OWNER] [--repo REPO]
 */
...
if (args.length === 0) {
    ...
    console.error('Usage: node apply-labels.js owner/repo');
    console.error('   or: node apply-labels.js --owner OWNER --repo REPO');
    process.exit(1);
}
